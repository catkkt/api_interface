...
public class InterfaceInfoController {
    ...
    public BaseResponse<Boolean> onlineInterfaceInfo(@RequestBody IdRequest idRequest,
        ...
        //判断该接口是否可以调用
        com.api.clientsdk.model.User user1 = new com.api.clientsdk.model.User();
        user1.setUsername("test1");
        String name = apiClient.getUserNameByPost(user1);
    ...
    public BaseResponse<Object> invokeInterfaceInfo(@RequestBody InterfaceInfoInvokeRequest interfaceInfoInvokeRequest,
        ...
        Gson gson = new Gson();
        com.api.clientsdk.model.User user = gson.fromJson(params, com.api.clientsdk.model.User.class);
